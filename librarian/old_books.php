			  ...
			  <div class="alert alert-info">
						...
						<!--  -->
								    <ul class="nav nav-pills">
										...
										<li><a href="new_books.php">新书</a></li>
										<li class="active"><a href="old_books.php">旧书</a></li>
						...
						<h1>旧书</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = '旧书'")or die(mysql_error());
