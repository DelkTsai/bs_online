...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		...
		?>
             <div class="alert alert-info"><i class="icon-pencil"></i>&nbsp;编辑图书信息</div>
			<p><a class="btn btn-info" href="books.php"><i class="icon-arrow-left icon-large"></i>&nbsp;返回</a></p>
	<div class="addstudent">
	<div class="details">请填写如下信息</div>	
	<form class="form-horizontal" method="POST" action="update_books.php" enctype="multipart/form-data">
			
		<div class="control-group">
			<label class="control-label" for="inputEmail">图书名:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="inputPassword">数量:</label>
			<div class="controls">
