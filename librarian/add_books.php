 ...
 ?>
    ...
    <div class="container">
		<div class="margin-top">
			...
			<p><a href="books.php" class="btn btn-info"><i class="icon-arrow-left icon-large"></i>&nbsp;返回</a></p>
	...
	<input type="text"  class="span4" id="inputPassword" name="author" value="<?php echo $douban_author;?>" placeholder="Author" required>
		...
		<div class="control-group">
			<div class="controls">
			<button name="submit" type="submit" class="btn btn-info"><i class="icon-save icon-large"></i>&nbsp;保存</button>
