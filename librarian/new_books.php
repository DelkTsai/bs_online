		...
		<div class="margin-top">
			...
			<div class="span12">
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;图书列表</strong>
                                </div>
						<!--  -->
								    <ul class="nav nav-pills">
										<li><a href="books.php">全部</a></li>
										<li  class="active"><a href="new_books.php">新书</a></li>
										<li><a href="old_books.php">旧书</a></li>
										<li><a href="lost.php">丢失</a></li>
										<li><a href="damage.php">损坏</a></li>
						...
						<h1>New Books</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
								...
								<p><a href="add_books.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;增加图书</a></p>
                                ...
                                <tbody>
                                  ...
                                  <?php $user_query = mysql_query("select * from book where status = '新书'") or die(mysql_error());
