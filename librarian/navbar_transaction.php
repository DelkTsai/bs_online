      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li><a href="users.php"><i class="icon-user icon-large"></i>&nbsp;用户</a></li>
					<li>
					<a href=""  data-toggle="dropdown" ><i class="icon-file icon-large"></i> 交易</a>
					...
					<li><a href="member.php"><i class="icon-group icon-large"></i>&nbsp;成员</a></li>
					...
					<li><a href="#logout" data-toggle="modal"><i class="icon-signout icon-large"></i>&nbsp;登出</a></li>
					</ul>
