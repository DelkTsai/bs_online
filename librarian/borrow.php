		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;借阅图书</strong>
                                </div>
			...
			<div class="control-group">
				...
				<div class="control-group"> 
					<div class="controls">
								...
								<button name="delete_student" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>点此借阅</button>
					</div>
				</div>
				</div>
				<div class="span8">
						<div class="alert alert-success"><strong>选择借阅书籍</strong></div>
